...
define('MANUAL_URL', G5_URL.'/manual');
define('MANUAL_PATH', G5_PATH.'/manual');
...
if(!file_exists(MANUAL_PATH.'/setting.php')) {
...
// 매뉴얼 설정값 불러오기
@include_once (MANUAL_PATH.'/setting.php');
...
if(!isset($config['as_thema']) || !$config['as_thema']) {
	...
	include_once (MANUAL_PATH.'/page.php');
}
