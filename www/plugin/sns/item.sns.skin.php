...
<ul id="it_v_sns">
	...
	<?php if(G5_IS_MOBILE && $config['cf_kakao_js_apikey']) { 
		$kakaothumb = apms_thumbnail($seo_image, 300, 0);
	?>
    <li><a href="javascript:kakaolink_send('<?php echo str_replace('\'', '', $sns_txt); ?>', '<?php echo $sns_url; ?>','<?php echo $kakaothumb['src'];?>', '300', '<?php echo $kakaothumb['height'];?>');"><img src="<?php echo G5_SNS_URL; ?>/icon/kakaotalk.png" alt="카카오톡으로 보내기"></a>
    <?php } ?>
