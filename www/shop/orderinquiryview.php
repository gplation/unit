...
/*
$sql = " select it_id, it_name, ct_send_cost, it_sc_type, pt_it
...
for($i=0; $row=sql_fetch_array($result); $i++) {
	...
	$res = sql_query($sql);
	$item[$i]['rowspan'] = mysql_num_rows($res) + 1;
...
list($skin_path, $skin_url) = apms_skin_path('orderinquiryview.skin.php', '/shop/inquiryview');
