...
<section id="bo_w" class="write-wrap">
	...
	<div class="form-group">
		<label class="col-sm-2 control-label hidden-xs">내용<strong class="sound_only">필수</strong></label></label>
		<div class="col-sm-10">
	...
	<div class="form-group">
		...
		<div class="col-sm-5">
			<input type="file" name="bf_file[1]" title="파일첨부 1 :  용량 <?php echo $upload_max_filesize; ?> 이하만 업로드 가능" class="form-control input-sm write-file">
		</div>
		<div class="col-sm-5">
			<?php if($w == 'u' && $write['qa_file1']) { ?>
				<label style="font-weight:normal"><input type="checkbox" id="bf_file_del1" name="bf_file_del[1]" value="1"> <?php echo $write['qa_source1']; ?> 파일 삭제</label>
			<?php } ?>
		</div>
	</div>	
	...
	<div class="form-group">
		...
		<div class="col-sm-5">
			<input type="file" name="bf_file[2]" title="파일첨부 2 :  용량 <?php echo $upload_max_filesize; ?> 이하만 업로드 가능" class="form-control input-sm write-file">
		</div>
		<div class="col-sm-5">
			<?php if($w == 'u' && $write['qa_file2']) { ?>
				<label style="font-weight:normal"><input type="checkbox" id="bf_file_del2" name="bf_file_del[2]" value="1"> <?php echo $write['qa_source2']; ?> 파일 삭제</label>
			<?php } ?>
		</div>
	</div>	
