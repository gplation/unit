...
<input type="hidden" name="pressed"  value="">
	...
	<div class="table-responsive">
		...
		<tr>
			...
			<?php } ?>
			<td class="text-center"><a href="./new.php?gr_id=<?php echo $list[$i]['gr_id'] ?>"><?php echo $gr_subject ?></a></td>
			<td class="text-center"><a href="./board.php?bo_table=<?php echo $list[$i]['bo_table'] ?>"><?php echo $bo_subject ?></a></td>
			<td><a href="<?php echo $list[$i]['href'] ?>"><?php echo $list[$i]['comment'] ?><?php echo $wr_subject ?></a></td>
			<td><?php echo $list[$i]['name'] ?></td>
			<td class="text-center" ><?php echo apms_datetime(strtotime($list[$i]['wr_datetime'])); ?></td>
		</tr>
		<?php }  ?>
