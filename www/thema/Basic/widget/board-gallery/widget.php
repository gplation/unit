...
?>
<div class="carousel<?php echo $effect;?> widget-board-gallery" id="<?php echo $carousel_id;?>" data-ride="carousel" data-interval="<?php echo $interval;?>">
...
<?php if($setup_href) { ?>
	<div class="btn-wset text-center" style="position:relative;">
