		...
		<div class="tbl_head01 tbl_wrap">
			...
			<?php for ($i=0; $row=sql_fetch_array($result); $i++) {	?>
				...
				<td align=center width=40>
					<input type="text" name="ca_order[<?php echo $i; ?>]" value='<?php echo $row['ca_order']; ?>' size="3" class="frm_input">
				</td>
				<td>
			...
			<?php
			if (!$i)
				echo '<tr><td colspan="15" class="empty_table"><span>자료가 없습니다.</span></td></tr>';
			?>
			</tbody>
			</table>
		</div>
