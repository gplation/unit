...
if($mode == 'shingo') {
	...
	if($row['id']) {
		if($row['flag']) {
			...
			$bo = sql_fetch(" select bo_subject from {$g5['board_table']} where bo_table = '$bo_table' ", false);
...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr>
        ...
        <td class="td_mng">
            <a href="./apms.admin.php?ap=shingo&amp;mode=shingo&amp;id=<?php echo $row['id']; ?>&amp;page=<?php echo $page;?>">
				해제
			</a>
        </td>
    </tr>
