...
if ($w == 'u') {
	...
	sql_query(" ALTER TABLE `{$g5['write_prefix']}{$board['bo_table']}` ADD `as_level` int(11) NOT NULL DEFAULT '1' AFTER `as_publish` ", false);
	...
	sql_query(" ALTER TABLE `{$g5['write_prefix']}{$board['bo_table']}` ADD `as_re_mb` varchar(20) NOT NULL DEFAULT '' AFTER `as_choice_mb` ", false);
...
$pg_anchor = '<ul class="anchor">
    ...
    <li><a href="#anc_bo_apms">APMS 설정</a></li>
...
<section id="anc_bo_apms">
    <h2 class="h2_frm">APMS 설정</h2>
    <?php echo $pg_anchor ?>

    <div class="tbl_frm01 tbl_wrap">
        <table>
        <caption>APMS 설정</caption>
        <colgroup>
            <col class="grid_4">
            <col>
            <col class="grid_3">
        ...
        <tr>
            ...
            <td class="td_grpset">
                <input type="checkbox" name="chk_grp_as_shigo" value="1" id="chk_grp_as_shingo">
		...
		<?php if(IS_YC) { ?>
		<tr>
            <th scope="row"><label for="as_partner">파트너 전용</label></th>
            <td>
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td>
                ...
                <?php echo get_skin_select('board', 'bo_mobile_skin', 'bo_mobile_skin', $board['bo_mobile_skin'], 'required'); // PC 스킨 폴더로 변경 ?>
            </td>
            <td class="td_grpset">
