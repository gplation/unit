...
<div class="tbl_head02 tbl_wrap">
    ...
    <tr>
		...
		<!-- APMS - 2014.07.20 -->
			<th scope="col" id="th_amt"><?php echo subject_sort_link('pt_commision', 'sca='.$sca); ?>수수료(%)</a></th>
			<th scope="col" id="th_amt"><?php echo subject_sort_link('pt_reserve', 'sca='.$sca); ?>예약일</a></th>
		<!-- // -->
    </tr>
    <tr>
		...
		<!-- APMS - 2014.07.20 -->
			<th scope="col" id="th_pt"><?php echo subject_sort_link('pt_incentive', 'sca='.$sca); ?>인센티브(%)</a></th>
			<th scope="col" id="th_pt"><?php echo subject_sort_link('pt_end', 'sca='.$sca); ?>종료일</a></th>
		<!-- // -->
    </tr>
    </thead>
    <tbody>
