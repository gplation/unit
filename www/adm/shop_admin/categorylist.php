...
<div id="sct" class="tbl_head02 tbl_wrap">
    ...
    <tr>
        ...
        <th scope="col" id="sct_imgcol">PC이미지 1행수</th>
		<th scope="col" id="sct_imgrow">PC이미지 행수</th>
        <th scope="col" id="sct_pcskin">PC목록스킨</th>
        <th scope="col" id="sct_pcskin">PC상품스킨</th>
    ...
    <tr>
		...
		<th scope="col" id="sct_amount">본인인증</th>
        ...
        <th scope="col" id="sct_order">출력순서</th>
        <th scope="col" id="sct_mskin">모바일목록스킨</th>
        <th scope="col" id="sct_mskin">모바일상품스킨</th>
    ...
    <tr class="<?php echo $bg; ?>">
		...
		<td headers="sct_admin" class="td_possible">
        ...
        <td headers="sct_pcskin">
            ...
            <select id="ca_skin_dir<?php echo $i; ?>" name="ca_skin_dir[<?php echo $i; ?>]" required class="required">
			<?php
		...
		<td class="td_mng">
			<select name="pt_form[<?php echo $i; ?>]" id="pt_form[<?php echo $i; ?>]">
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td headers="sct_mskin">
            ...
            <select id="ca_mobile_skin_dir<?php echo $i; ?>" name="ca_mobile_skin_dir[<?php echo $i; ?>]" required class="required">
			<?php
				for ($k=0; $k<count($itemskin); $k++) {
		...
		<td class="td_mng">
			...
			<select name="pt_item[<?php echo $i; ?>]" id="pt_item<?php echo $i; ?>">
    ...
    <?php }
    if ($i == 0) echo "<tr><td colspan=\"14\" class=\"empty_table\">자료가 한 건도 없습니다.</td></tr>\n"; // APMS : 2014.07.20
    ?>
    </tbody>
    </table>
</div>
