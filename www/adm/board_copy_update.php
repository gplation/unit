...
sql_query(" ALTER TABLE `{$g5['write_prefix']}{$target_table}` ADD `as_level` int(11) NOT NULL DEFAULT '1' AFTER `as_publish` ", false);
...
sql_query(" ALTER TABLE `{$g5['write_prefix']}{$target_table}` ADD `as_choice_mb` varchar(20) NOT NULL DEFAULT '' AFTER `as_choice` ", false);
sql_query(" ALTER TABLE `{$g5['write_prefix']}{$target_table}` ADD `as_re_mb` varchar(20) NOT NULL DEFAULT '' AFTER `as_choice_mb` ", false);
