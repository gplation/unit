...
if($q || $stx) {
	...
	$list_page = $_SERVER['PHP_SELF'].'?q='.urlencode($q).'&amp;page=';

	list($skin_path, $skin_url) = apms_skin_path('tag.search.skin.php', '/bbs/tag');
	...
	list($skin_path, $skin_url) = apms_skin_path('tag.skin.php', '/bbs/tag');
